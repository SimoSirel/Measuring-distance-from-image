...
if __name__ == '__main__':
    ...
    fps_reduction = params.get('-fps_reduce', 2)
    ...
    left_video = cv2.VideoWriter(left_video_filepath, fourcc, fps, (width, height))
    right_video = cv2.VideoWriter(right_video_filepath, fourcc, fps, (width, height))
